-- DIRECT FIX - Create tables with the EXACT names causing the error
-- This will create the table the system is looking for
...
-- Create the table with the EXACT name the error is looking for
...
-- Also create the standard names as backup
...
-- Insert data into both table sets
...
SELECT 'Both table naming variations created successfully!' as Status;